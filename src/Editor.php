...
class Editor
{
     ...
     * @var Boolean
     */
    protected static $shortcodeButtonsPrepared = false;
     ...
     * @return string
     */
    protected static function getButtonsFilter($number)
    {
     ...
     * @param  bool  $keepButton  (Optional) keep the toggle button
     */
     ...
     *                              null places the button at the end
     * @param  int  $toolbar    (Optional) the toolbar number, 1 = default, 2/3/4 = advanced
     * @param  int  $toToolbar  (Optional) the toolbar to move the button to
     ...
     *                            'first' places the button as the first one
     *                            null places the button at the end
     * @param  int  $toolbar  (Optional) the toolbar number, 1 = default, 2/3/4 = advanced, or false to not add
     */
     ...
     * @return string
     */
    protected static function useTinyMceType($type)
    {
        if ($type == 'text') {
            return 'textbox';
    ...
    public static function addShortcodeButton($shortcode, $after = null, $toolbar = 1)
    {
        ...
        if (! static::$shortcodeButtonsPrepared) {
            ...
            static::$shortcodeButtonsPrepared = true;
        }
